...
//   MCP / StateTwins              ─ the technical surfaces buyers/builders use
...
// `/mcp` or `/statetwins`) they route home, then scroll. `/mcp` and
// `/statetwins` are real routes.
const sectionLinks = [
  { label: "Services", href: "/#services" },
  { label: "Method", href: "/#method" },
  { label: "Research", href: "/#research" },
  { label: "MCP", href: "/mcp" },
  { label: "StateTwins", href: "/statetwins" },
